...
EMAIL_HOST_USER = os.environ.get('EMAIL_HOST_USER', 'jis.sajjat78@gmail.com')
EMAIL_HOST_PASSWORD = os.environ.get('EMAIL_HOST_PASSWORD', 'uaoy xofq ouvi gtdi')
EMAIL_USE_TLS = True
EMAIL_USE_SSL = False
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', 'X Bank <jis.sajjat78@gmail.com>')
